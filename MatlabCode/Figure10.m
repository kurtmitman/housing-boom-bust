...
%%
    ...
    subplot2=subplot(2,3,1,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchPh,trangeq,relphD,'--k');xlim([trange(1) trange(end)]);title('House Price','FontSize',14);grid on;xlabel('Year');ylim([0.8 1.4]);
    subplot2=subplot(2,3,2,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchC,trangeq,ndcD,'--k');xlim([trange(1) trange(end)]);title('Consumption','FontSize',14);grid on;xlabel('Year');
    subplot2=subplot(2,3,3,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchPr,trangeq,rPratioD,'--k');xlim([trange(1) trange(end)]);title('Rent Price Ratio','FontSize',14);grid on;xlabel('Year');ylim([0.4 1.2]);
    subplot2=subplot(2,3,4,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchOwn,trangeq,ownD,'--k');xlim([trange(1) trange(end)]);title('Home Ownership','FontSize',14);grid on;xlabel('Year');ylim([0.95 1.1]);
    subplot2=subplot(2,3,5,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchLev,trangeq,ltvD,'--k');xlim([trange(1) trange(end)]);title('Leverage','FontSize',14);grid on;xlabel('Year');ylim([0.8 1.6]);
    subplot2=subplot(2,3,6,'FontSize',12);
        box(subplot2,'on');
        grid(subplot2,'on');
        hold(subplot2,'on');plot(trange,BenchFore,trangeq,foreD,'--k');xlim([trange(1) trange(end)]);title('Foreclosure','FontSize',14);grid on;xlabel('Year');
