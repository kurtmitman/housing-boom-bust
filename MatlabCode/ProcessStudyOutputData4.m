global BaseC BasePh BaseLev BaseRefi BaseFore BaseOwn BasePr
...
for jj =1:size(indices{1},2)
    ...
    refiID{j}=refiI{j}./BaseRefi;
    foreID{j}=foreI{j}-BaseFore;
    ...
    PrPhID{j}=(pathPr{j}(range_irf)./pathPh{j}(range_irf))./BasePr;
