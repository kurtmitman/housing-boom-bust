...
integer,parameter   :: Tsim = 1000*exogenous + (1-exogenous)*(5000+(1-Benchmark)*5000)
...
integer,parameter :: ngpC      = 2-Benchmark
integer,parameter   :: ngpZh = 1
integer,parameter   :: ngpHD = 1+2*(1-Benchmark)
...
integer,parameter   :: nsimss=exogenous*500+(1-exogenous)*5000
...
integer,parameter  ::  NoDeathInRetirement              = 1
integer,parameter  ::  FlatEarningsProfile              = 0
integer,parameter  ::  NoInitialWealth                  = 0
...
integer,parameter :: ngpey      = 1               !transitory component earnings
integer,parameter :: ngpzy      = oneguy+5*(1-oneguy)+DoMJ !11 !15                        !permanent component earnings
integer,parameter :: ngpfylev   = 1                                       !fixed effect earnings: levels
integer,parameter :: ngpfyslo   = 1                               !fixed effect earnings: slopes
