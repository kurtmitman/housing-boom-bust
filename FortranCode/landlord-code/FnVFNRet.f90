...
!call BiLinInterp1(nb,GridB,ngpPh,PhGrid,qlret(:,gil,ginds(1),gih,giExo,:,gij+1),bsav,gPh,qltemp)
!call BiLinInterp1(nb,GridB,ngpPh,PhGrid,qlret(:,gil,ginds(2),gih,giExo,:,gij+1),bsav,gPh,qltemp2)
